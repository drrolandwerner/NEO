...
{	
	...
	*/
	...
	//d3.json(theDocData, function(jsonData) 
	$( document ).ready(function() 
	{
		jsonData = theDocData; //.slice();
...
*/
	...
	var valueAxisObj = {line: {visible: false},minorGridLines: {visible: false},labels: {format: "{0:n0}"}};
